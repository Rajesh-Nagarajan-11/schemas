...
type Role struct {
	...
	// DeletedAt Timestamp when the role was soft-deleted.
...
type RolesKeychainsMapping struct {
	...
	KeychainId uuid.UUID `db:"keychain_id" json:"keychain_id" yaml:"keychain_id"`
	...
	RoleId    uuid.UUID `db:"role_id" json:"role_id" yaml:"role_id"`
	CreatedAt time.Time `db:"created_at" json:"created_at" yaml:"created_at"`
	UpdatedAt time.Time `db:"updated_at" json:"updated_at" yaml:"updated_at"`
